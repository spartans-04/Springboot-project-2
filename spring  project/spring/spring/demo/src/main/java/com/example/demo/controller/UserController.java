...
public class UserController {
    ...
    @GetMapping("/users/pagesorting/{offset}/{pagesize}/{field}")
    public ResponseEntity<List<User>> Pagesort(@PathVariable int offset,@PathVariable int pagesize,@PathVariable String field){
        List<User> T = userService.pageSorting(offset, pagesize, field);
